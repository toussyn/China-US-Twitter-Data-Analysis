...
class TweetDfExtractor:
    ...
    def __init__(self, tweets_list):
        """
        Constructor of the TweetDfExtractor
        Attrs
            * tweets_list - The list of twets
        """
    ...
    def find_statuses_count(self)->list:
        """
        A function that makes a list based on find statuses_count
        Returns
    ...
    def find_full_text(self)->list:
        """Make and return a full_text list"""
        text = [tweet['full_text'] for tweet in self.tweets_list]
        return text
       
    def find_sentiments(self, text)->list:
        """Make and return a ploarity and subjectivity lists"""
    ...
    def find_followers_count(self)->list:
        """Make and return a followers_count list"""
    ...
    def is_sensitive(self)->list:
        """Make and return a is_sensitive list"""
        is_sensitive = []
